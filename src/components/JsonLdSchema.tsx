    ...
    '@graph': [
        ...
        },
        {
            ...
            itemListElement: [
                ...
                { '@type': 'ListItem', position: 4, name: "I'm New Here", item: 'https://www.gwparish.org.au/new-here' },
                { '@type': 'ListItem', position: 5, name: 'News & Events', item: 'https://www.gwparish.org.au/news' },
                { '@type': 'ListItem', position: 6, name: 'History', item: 'https://www.gwparish.org.au/history' },
                { '@type': 'ListItem', position: 7, name: 'Contact', item: 'https://www.gwparish.org.au/contact' },
            ],
        },
        {
            '@type': 'Event',
