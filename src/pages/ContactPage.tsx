...
export function ContactPage() {
    ...
    return (
        <div className="min-h-screen bg-parish-bg pt-28 pb-24 px-6 md:px-16 lg:px-24">
            <PageMeta title="Contact Us" description="Contact Greenacres Walkerville Catholic Parish. Parish office at 56-80 Princes Road, Greenacres SA 5086. Phone (08) 8261 6200. Find St Monica's and St Martin's churches." path="/contact" />
